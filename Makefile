...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/05/29 13:02:15 by cseabela          #+#    #+#              #
#    Updated: 2018/06/12 15:43:55 by cseabela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c\
	   ...
	   ft_striteri.c ft_strmapi.c ft_strmap.c ft_strequ.c ft_strnequ.c ft_strsub.c ft_strjoin.c\
...
OBJS = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memchr.o ft_memcmp.o\
	   ...
	   ft_strmapi.o ft_strmap.o ft_strequ.o ft_strnequ.o ft_strsub.o ft_strjoin.o ft_strtrim.o\
